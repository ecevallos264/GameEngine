...
/// @ingroup ext
///
/// Exposes comparison functions for scalar scene_types that take a user defined epsilon values.
///
...
namespace glm
{
	...
	///
	/// @tparam genType Floating-point or integer scalar scene_types
