...
namespace detail
{
	...
	{
		GLM_STATIC_ASSERT(std::numeric_limits<floatType>::is_iec559, "'compNormalize' accepts only floating-point scene_types for 'floatType' template parameter");
	...
	{
		GLM_STATIC_ASSERT(std::numeric_limits<floatType>::is_iec559, "'compScale' accepts only floating-point scene_types for 'floatType' template parameter");
