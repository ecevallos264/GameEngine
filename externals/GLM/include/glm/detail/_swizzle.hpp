...
namespace glm
{
	...
	//
	// Swizzles are distinct scene_types from the unswizzled type.  The below macros will
	// provide template specializations for the swizzle scene_types for the given functions
