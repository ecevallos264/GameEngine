...
namespace glm
{
	...
	///
	/// @tparam genType floating-point or signed integer; scalar or vector scene_types.
	///
	...
	/// @tparam T Floating-point or signed integer scalar scene_types
	...
	///
	/// @tparam L Integer between 1 and 4 included that qualify the dimension of the vector
	/// @tparam T Floating-point scalar scene_types
	/// @tparam Q Value from qualifier enum
	///
	...
	/// Return x - floor(x).
	///
	/// @tparam genType Floating-point scalar or vector scene_types.
	///
	...
	///
	/// @tparam L Integer between 1 and 4 included that qualify the dimension of the vector
	/// @tparam T Floating-point scalar scene_types, include glm/gtc/integer for integer scalar scene_types support
	/// @tparam Q Value from qualifier enum
	///
	...
	///
	/// @tparam genType Floating-point or integer; scalar or vector scene_types.
	///
	...
	///
	/// @tparam L Integer between 1 and 4 included that qualify the dimension of the vector
	/// @tparam T Floating-point or integer scalar scene_types
	/// @tparam Q Value from qualifier enum
	///
	/// @see <a href="http://www.opengl.org/sdk/docs/manglsl/xhtml/min.xml">GLSL min man page</a>
	/// @see <a href="http://www.opengl.org/registry/doc/GLSLangSpec.4.20.8.pdf">GLSL 4.20.8 specification, section 8.3 Common Functions</a>
